...
with col1:
    ...
    invalid_placeholder_1 = st.empty()
with col2:
    st.subheader("Player 2 Board")
    board_placeholder_2 = st.empty()
    invalid_placeholder_2 = st.empty()
...
if start_button:
    ...
    invalid_placeholder_1.markdown("Invalid Moves: ")
    invalid_placeholder_2.markdown("Invalid Moves: ")
    ...
    for state in game.run_game_live():
        ...
        invalid_placeholder_1.markdown(
            "Invalid Moves: " + "❌" * state['invalid_move_counts']['player_1']
        )
        invalid_placeholder_2.markdown(
            "Invalid Moves: " + "❌" * state['invalid_move_counts']['player_2']
        )
